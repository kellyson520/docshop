...
class TestDocDistException(unittest.TestCase):
    """测试基础异常类"""

    def test_init_default(self):
        """测试默认初始化"""
        exc = DocDistException("测试错误")
    ...
    def test_init_with_code(self):
        """测试带错误码初始化"""
        exc = DocDistException("测试错误", code=40001)
        
        self.assertEqual(exc.code, 40001)

    def test_init_with_details(self):
        """测试带详情初始化"""
        exc = DocDistException("测试错误", details={"field": "username"})
    ...
    def test_to_dict_with_details(self):
        """测试带详情的to_dict"""
        exc = DocDistException("测试错误", code=40001, details={"field": "username"})
        result = exc.to_dict()
    ...
    def test_to_dict_empty_details(self):
        """测试空详情的to_dict"""
        exc = DocDistException("测试错误", code=40001, details={})
        result = exc.to_dict()
...
class TestExceptionInheritance(unittest.TestCase):
    ...
    def test_all_inherit_from_base(self):
        ...
        for exc in exceptions:
            self.assertIsInstance(exc, DocDistException)
...
class TestExceptionEdgeCases(unittest.TestCase):
    ...
    def test_unicode_message(self):
        """测试Unicode消息"""
        exc = DocDistException("中文错误消息: 测试")
        result = exc.to_dict()
