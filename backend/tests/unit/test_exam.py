...
def mock_exam():
    ...
    exam.start_time = (utc_now() + timedelta(days=1)).isoformat() + "Z"
    exam.end_time = (utc_now() + timedelta(days=1, hours=2)).isoformat() + "Z"
...
def mock_ongoing_exam():
    ...
    exam.start_time = (utc_now() - timedelta(minutes=30)).isoformat() + "Z"
    exam.end_time = (utc_now() + timedelta(hours=1)).isoformat() + "Z"
    exam.project_id = "test-project-id-123"
...
def mock_expired_exam():
    ...
    exam.start_time = (utc_now() - timedelta(days=2)).isoformat() + "Z"
    exam.end_time = (utc_now() - timedelta(days=1)).isoformat() + "Z"
    exam.project_id = "test-project-id-123"
...
class TestExamStatusModel:
    ...
    def test_exam_schedule_get_time_until_end(self, test_user, test_project, db_session):
        """测试获取距离考试结束的分钟数"""
        start_time = (utc_now() - timedelta(minutes=30)).isoformat() + "Z"
        end_time = (utc_now() + timedelta(minutes=30)).isoformat() + "Z"
