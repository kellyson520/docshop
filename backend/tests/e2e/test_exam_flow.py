...
class TestExamLifecycle:
    ...
    def test_exam_status_transition(self, client, auth_headers, db_session, test_user):
        ...
        ongoing_start = (datetime.utcnow() - timedelta(minutes=30)).isoformat() + "Z"
        ongoing_end = (datetime.utcnow() + timedelta(hours=1)).isoformat() + "Z"
        ...
        # 6. 更新考试时间为已结束
        expired_start = (datetime.utcnow() - timedelta(days=2)).isoformat() + "Z"
        expired_end = (datetime.utcnow() - timedelta(days=1)).isoformat() + "Z"
