  ...
  <footer class="app-footer" :class="{ 'app-footer--dark': isDark }">
    <div class="footer-container">
      ...
      <div class="footer-content">
        ...
        <div class="footer-section footer-brand">
          <div class="brand-logo">
            ...
            <span class="brand-name">DocShop</span>
          </div>
          <p class="brand-desc">
      ...
      <div class="footer-bottom">
        <p class="copyright">
          &copy; {{ currentYear }} DocShop. All rights reserved.
        </p>
...
const socialLinks = [
  ...
  { name: '官网', url: 'https://docshop.com', icon: Link }
]
...
// 联系信息
const contactInfo = [
  { type: 'email', value: 'support@docshop.com', icon: Message },
