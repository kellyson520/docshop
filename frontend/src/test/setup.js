...
// Mock window.matchMedia：Element Plus 响应式组件依赖
...
vi.mock('@element-plus/icons-vue', () => ({
  ...
  RefreshRight: { name: 'RefreshRight', render: () => null },
  ...
  MoreFilled: { name: 'MoreFilled', render: () => null },
  ...
  InfoFilled: { name: 'InfoFilled', render: () => null },
  SuccessFilled: { name: 'SuccessFilled', render: () => null },
  CircleCheck: { name: 'CircleCheck', render: () => null },
  CircleCloseFilled: { name: 'CircleCloseFilled', render: () => null },
  DataLine: { name: 'DataLine', render: () => null },
  DataBoard: { name: 'DataBoard', render: () => null },
  ...
  Bell: { name: 'Bell', render: () => null },
  CaretBottom: { name: 'CaretBottom', render: () => null },
  CaretTop: { name: 'CaretTop', render: () => null },
  ChatDotRound: { name: 'ChatDotRound', render: () => null },
  ChatLineRound: { name: 'ChatLineRound', render: () => null },
  CollectionTag: { name: 'CollectionTag', render: () => null },
  CopyDocument: { name: 'CopyDocument', render: () => null },
  EditPen: { name: 'EditPen', render: () => null },
  Expand: { name: 'Expand', render: () => null },
  Filter: { name: 'Filter', render: () => null },
  Flag: { name: 'Flag', render: () => null },
  Fold: { name: 'Fold', render: () => null },
  FullScreen: { name: 'FullScreen', render: () => null },
  Grid: { name: 'Grid', render: () => null },
  Hide: { name: 'Hide', render: () => null },
  Histogram: { name: 'Histogram', render: () => null },
  Key: { name: 'Key', render: () => null },
  Link: { name: 'Link', render: () => null },
  List: { name: 'List', render: () => null },
  Location: { name: 'Location', render: () => null },
  Message: { name: 'Message', render: () => null },
  Monitor: { name: 'Monitor', render: () => null },
  Notification: { name: 'Notification', render: () => null },
  OfficeBuilding: { name: 'OfficeBuilding', render: () => null },
  Phone: { name: 'Phone', render: () => null },
  Platform: { name: 'Platform', render: () => null },
  PriceTag: { name: 'PriceTag', render: () => null },
  Share: { name: 'Share', render: () => null },
  Star: { name: 'Star', render: () => null },
  StarFilled: { name: 'StarFilled', render: () => null },
  SwitchButton: { name: 'SwitchButton', render: () => null },
  Timer: { name: 'Timer', render: () => null },
  TrendCharts: { name: 'TrendCharts', render: () => null },
  Trophy: { name: 'Trophy', render: () => null }
}))
